        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <form role="form" method="post" action="{{ $id ? route('admin.product.edit.handle') : route('admin.product.add.handle') }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        @if ($id)
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6 form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="name" type="text" value="{{ $id ? $product->name : old('name') }}" required="true">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group col-md-3 col-sm-6 {{ $errors->has('brand') ? 'has-error' : '' }}">
                                    ...
                                    <select name="brand" class="form-control">
                                        ...
                                        <option value="{{ $brand->id }}" @if ($id) @if($product->brand->id == $brand->id) {{ "selected" }} @endif @endif>{{ $brand->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @if ($errors->has('brand'))
                                ...
                                <div class="form-group col-md-3 col-sm-6 {{ $errors->has('category') ? 'has-error' : '' }}">
                                    ...
                                    <select name="category" class="form-control" value="{{ old('category') }}">
                                        ...
                                        <option value="{{ $category->id }}" @if ($id) @if($product->category->id == $category->id) {{ "selected" }} @endif @endif>{{ $category->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="text" name="price" value="{{ $id ? $product->price : old('price') }}" required="true">
                                    @if ($errors->has('price'))
                                ...
                                <div class="col-md-3 col-sm-6 form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" name="quantity" value="{{ $id ? $product->quantity : old('quantity') }}" required="true">
                                ...
                                <div class="col-md-6 col-sm-12 form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="file" name="image" required="true" value="{{ $id ? $product->image : '' }}">
                                    @if ($errors->has('image'))
