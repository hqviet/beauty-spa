...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <form role="form" action="{{ $action == 'create' ? route('admin.product.add.handle') : route('admin.product.edit.handle') }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                @if ($id)
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12 form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                            ...
                                            @endphp
                                            @endif
                                            <input class="form-control" name="name_{{ $k }}" type="text" value="{{ $name }}"
                                                required="true">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group {{ $errors->has('desc_en') ? 'has-error' : '' }}">
                                            ...
                                            @endphp
                                            @endif
                                            <textarea class="form-control" name="description_{{ $k }}" rows="6"
                                                required="true">{{ $desc }}</textarea>
