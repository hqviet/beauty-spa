...
@section('left_side_bar')
    @include('admin.layout.left_side_bar', ['active' => 'profile'])
@endsection
@section('content')
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <h3 class="profile-username text-center">{{ $authUser->first_name }}</h3>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <p class="text-muted">Hà Đông, Hà Nội</p>
                ...
                <div class="col-md-9">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            @include('admin.pages.profile.setting')
                            <!-- /.tab-pane -->
