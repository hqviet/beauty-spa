                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="vi">
                                <form class="form-horizontal" method="POST" action="{{ route('admin.schedule.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 {{$errors->has('date')? 'has-error' : ''}}">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right" id="datepicker" name="date" value="{{ date('Y-m-d') }}" />
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 {{$errors->has('message')? 'has-error' : ''}}">
                                            <textarea class="ckeditor" name="message" rows="10"
                                                      id="message"  cols="80">{{ old('message') }}</textarea>
